...
const Footer = () => {
  return (
    <footer className="bg-[#DB3986] text-white py-12">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Vienna Sultans</h3>
            <p className="text-white">
              Your premier cricket destination in Vienna, Austria.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#matches" className="text-white hover:text-white transition-colors">
                  Matches
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-white">
          <p>&copy; {new Date().getFullYear()} Vienna Sultans Cricket Club. All rights reserved.</p>
          <div className="mt-4 flex items-center justify-center space-x-2">
            <span className="text-sm text-gray-300">Developed by</span>
            <motion.a
              href="https://www.linkedin.com/in/asad-ullah-b17b49180/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#00BFFF] hover:text-[#0099CC] transition-colors flex items-center space-x-1"
