    ...
    <div className="fixed bottom-4 right-4 z-50">
      {!isOpen ? (
        <button
          ...
          className="bg-[#00BFFF] text-white px-6 py-3 rounded-full shadow-lg hover:bg-[#0099CC] transition-colors"
        >
          Add Player
        </button>
      ) : (
        <div className="bg-[#0D0D2B] p-6 rounded-lg shadow-xl w-[800px] max-h-[90vh] overflow-y-auto">
